...
export default function SupplierNewPage() {
  ...
  const [form, setForm] = useState({
    name: '',
    cnpj: '',
    category: 'medicamentos' as SupplierCategory,
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setMessage('Fornecedor cadastrado (modo demonstração — API /api/suppliers ainda não implementada).');
    setSaving(false);
  ...
  return (
    <AppShell pageTitle="Novo fornecedor">
      <div className="page-header">
        ...
        <p className="page-subtitle">Cadastre um parceiro ou terceiro no hospital</p>
      </div>
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input id="cnpj" type="text" value={form.cnpj} onChange={(e) => setForm({ ...form, cnpj: e.target.value })} className={input} placeholder="00.000.000/0000-00" required />
          </div>
