  ...
  return (
    <AppShell pageTitle="Bundle Hora-1 — Sepse">
      <div className="mx-auto flex max-w-4xl flex-col gap-6 p-4 md:p-6">
        <section className="rounded-xl border border-neutral-200 bg-white p-6 text-neutral-900">
          <h1 className="text-2xl font-bold text-neutral-900">Bundle Hora-1 para Sepse</h1>
          <p className="mt-3 text-sm leading-relaxed text-neutral-700">
            ...
            <span className="font-semibold text-neutral-900">maior ou igual a 5</span>, ou um único
            parâmetro com pontuação 3, deve acionar o{' '}
            <span className="font-semibold text-neutral-900">Code Sepsis</span> e a execução do
