    ...
    <AppShell pageTitle="Sepsis Hour-1 Bundle">
      <div className="mx-auto flex max-w-4xl flex-col gap-6 p-4 md:p-6">
        <section className="rounded-xl border border-slate-700 bg-slate-900 p-6 text-slate-50">
          <h1 className="text-2xl font-bold text-slate-50">Sepsis Hour-1 Bundle</h1>
          <p className="mt-3 text-sm leading-relaxed text-slate-200">
            ...
            <span className="font-semibold text-slate-50">maior ou igual a 5</span>, ou um unico
            parametro com pontuacao 3, deve acionar o{' '}
            <span className="font-semibold text-slate-50">Code Sepsis</span> e a execucao do Hour-1
