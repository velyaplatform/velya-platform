...
_This register is the authoritative source of platform gaps. Each gap must be linked to a corresponding issue in the project tracker. Status updates are required weekly by the owning team._
