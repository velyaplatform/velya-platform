...
const maskingRules: MaskingRule[] = [
  ...
  {
    field: 'patient.identifier[cpf]',
    roles: ['ENF_ASSISTENCIAL', 'ENF_UTI', 'ENF_EMERG', 'ENF_CC', 'ASSIST_SOCIAL'],
    maskType: 'truncate',
...
| --- | ------------------------------------------------------------- | ------------------- | ----------- | --------------------------------------------------------------- |
| 1   | CPF visivel na view clinica do medico                         | MED\_\*             | Baixo       | Mascarar CPF na view clinica, manter em cadastro                |
| 2   | Convenio visivel na view clinica do medico                    | MED\_\*             | Baixo       | Remover da view clinica                                         |
| 3   | Evolucao medica completa visivel para enfermeiro              | ENF\_\*             | Medio       | Exibir resumo por padrao, texto completo sob demanda            |
| 4   | Resultados laboratoriais completos para enfermeiro            | ENF\_\*             | Baixo       | Filtrar por relevancia para enfermagem                          |
| 5   | Notas psiquiatricas visiveis para todos os medicos            | MED\_\* (nao psiq.) | Alto        | Restringir a psiquiatras + medico responsavel com justificativa |
| 6   | Prescricao completa visivel para tecnico de enfermagem        | TEC_ENF             | Baixo       | Filtrar para itens atribuidos ao tecnico                        |
| 7   | Prescricao completa de medicamentos visivel para fisioterapia | FISIO\_\*           | Baixo       | Filtrar para classes relevantes (broncodilatadores, sedacao)    |
