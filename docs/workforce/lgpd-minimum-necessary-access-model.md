...
const maskingRules: MaskingRule[] = [
  {
    ...
    rules: [
      {
        applies_to_roles: ['recepcao', 'auditoria'],
  ...
  },
  {
    ...
    rules: [
      {
        applies_to_roles: ['tecnico_enfermagem'],
        mask_type: MaskType.REDACT,
        replacement: '[Resumo disponivel]',
      },
      { applies_to_roles: ['faturamento'], mask_type: MaskType.PARTIAL }, // Apenas CID
      {
        applies_to_roles: ['recepcao', 'higienizacao', 'maqueiro', 'manutencao', 'ti', 'seguranca'],
  ...
  },
  {
    ...
    rules: [
      {
        applies_to_roles: ['recepcao', 'faturamento'],
        mask_type: MaskType.PARTIAL,
        visible_chars: 4,
      },
      { applies_to_roles: ['*'], mask_type: MaskType.FULL },
