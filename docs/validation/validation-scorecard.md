...
_Scorecard reviewed at: each major milestone. Scores are evidence-based, not self-assessed. Evidence sources recorded in docs/validation/evidence-index.md._
