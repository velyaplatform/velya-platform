...
*Esta política é revisada a cada trimestre ou quando um novo componente de infraestrutura é avaliado. Toda exceção requer aprovação de arquitetura formal.*
