...
```json
{
  ...
  "by_category": {
    "compute": {"cost_usd": 28.50, "percent": 63.0},
    "storage": {"cost_usd": 8.20, "percent": 18.1},
    "llm_inference": {"cost_usd": 6.80, "percent": 15.0},
    "networking": {"cost_usd": 1.73, "percent": 3.8}
  },
  
  "by_namespace": {
    "velya-dev-core": {"cost_usd": 15.20, "budget_usd": 200, "utilization": "7.6%"},
    "velya-dev-agents": {"cost_usd": 12.80, "budget_usd": 300, "utilization": "4.3%"},
    "velya-dev-observability": {"cost_usd": 10.50, "budget_usd": 150, "utilization": "7.0%"},
    "velya-dev-platform": {"cost_usd": 5.23, "budget_usd": 150, "utilization": "3.5%"},
    "velya-dev-web": {"cost_usd": 1.50, "budget_usd": 100, "utilization": "1.5%"}
  },
  ...
  "llm_inference_detail": {
    ...
    "by_model": {
      "gpt-4o-mini": {"cost_usd": 4.20, "tokens": 2200000},
      "claude-3-5-sonnet": {"cost_usd": 2.60, "tokens": 600000}
    },
    "by_office": {
      "clinical-operations": {"cost_usd": 2.10, "budget_daily_usd": 1.00, "status": "over_budget"},
      "validation-office": {"cost_usd": 1.80, "budget_daily_usd": 0.67, "status": "over_budget"},
      "governance-office": {"cost_usd": 1.50, "budget_daily_usd": 0.83, "status": "over_budget"},
      "learning-office": {"cost_usd": 0.80, "budget_daily_usd": 0.33, "status": "over_budget"},
      "intelligence-office": {"cost_usd": 0.60, "budget_daily_usd": 0.27, "status": "over_budget"}
    }
  },
