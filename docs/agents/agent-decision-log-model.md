...
decision_log_entry:
  ...
  # ─── DECISION CONTEXT ────────────────────────────────────
  decision_type:
    enum: [approach_selection, escalation, exception_request, correction_design,
           risk_reclassification, permission_expansion, handoff_rejection,
           scope_interpretation, fallback_activation, task_decomposition]
